...
public class MembersMgt {
  ...
  public void init() throws Exception {
    ...
    Reflections reflections = new Reflections("java02jw.test16");
    Set<Class<?>> clazzList = 
    ...
    for (Class clazz : clazzList) {
      ...
      try { 
        method = clazz.getMethod("setMembersDao", MembersDao.class);
        method.invoke(command, membersDao);
      } catch (Exception e) {}
