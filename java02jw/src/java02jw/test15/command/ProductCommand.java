...
import java02jw.test15.Product;
...
public class ProductCommand {
  ...
  public void update(Map<String, Object> params) {
    ...
    Product product = productDao.selectOne(no);
    if (product == null) {
      System.out.println("해당 인덱스의 제품 정보를 찾을 수 없습니다.");
      return;
    }
    ...
    System.out.printf("제품(%s):", product.getName());
    ...
    System.out.printf("제조사번(%d):", product.getMakerNo());
    text = scanner.nextLine();
    if (text.length() > 0)
